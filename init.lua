...
vim.api.nvim_set_hl(0, "rubyRailsUserClass", { fg = sky_blue })
...
vim.api.nvim_set_hl(0, "javaScriptFunction", { fg = sky_blue })
...
vim.api.nvim_set_hl(0, "shDerefSimple", { fg = sky_blue })
vim.api.nvim_set_hl(0, "markdownUrl", { fg = sky_blue })
vim.api.nvim_set_hl(0, "markdownLink", { fg = sky_blue })
...
vim.api.nvim_set_hl(0, "Identifier", { fg = sky_blue })
vim.api.nvim_set_hl(0, "StorageClass", { fg = sky_blue })
vim.api.nvim_set_hl(0, "rubyConstant", { fg = sky_blue })
...
vim.api.nvim_set_hl(0, "Todo", { fg = comment_grey })
...
vim.api.nvim_set_hl(0, "StatusLine", { fg = alternate_foreground, bg = status_back })
vim.api.nvim_set_hl(0, "StatusLineNC", { fg = alternate_foreground, bg = status_back })
vim.api.nvim_set_hl(0, "DiffAdd", { fg = alternate_foreground, bg = diff_add })
...
vim.api.nvim_set_hl(0, "DiffText", { fg = alternate_foreground, bg = unnamed7 })
vim.api.nvim_set_hl(0, "Special", { fg = alternate_foreground })
vim.api.nvim_set_hl(0, "Title", { fg = alternate_foreground })
